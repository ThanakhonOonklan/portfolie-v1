    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          ...
          <div
            className={cx(
              'relative h-[var(--logoloop-logoHeight)] w-auto',
          ...
          >
            <Image
              ...
              title={item.title}
              fill
              sizes={item.sizes ?? '(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw'}
              unoptimized={!item.width || !item.height}
              draggable={false}
            />
          </div>
        );
        ...
        const itemHref = isNodeItem ? item.href : item.href;
